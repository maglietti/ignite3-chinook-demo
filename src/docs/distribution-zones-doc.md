...
More partitions allow for finer-grained distribution but increase overhead. The default is typically calculated based on cluster size and other factors.
